...
bool CPrivateAddress::SetEncoded(const std::string& encodedAddress)
{
    data_chunk raw;
    ...
    {
        if (fDebug)
            LogPrintf("CPrivateAddress::SetEncoded DecodeBase58 failed.\n");
        return false;
    };
    ...
    {
        if (fDebug)
            LogPrintf("CPrivateAddress::SetEncoded verify_checksum failed.\n");
        return false;
    };
    ...
    {
        if (fDebug)
            LogPrintf("CPrivateAddress::SetEncoded() too few bytes provided.\n");
        return false;
    };
    ...
    if (version != private_version_byte)
    {
        LogPrintf("CPrivateAddress::SetEncoded version mismatch 0x%x != 0x%x.\n", version, private_version_byte);
        return false;
    };
...
std::string CPrivateAddress::Encoded() const
{
    // https://wiki.unsystem.net/index.php/DarkWallet/Private#Address_format
    // [version] [options] [scan_key] [N] ... [Nsigs] [prefix_length] ...
    
    data_chunk raw;
    raw.push_back(private_version_byte);
...
int CPrivateAddress::SetScanPubKey(CPubKey pk)
{
...
int PrivateSecret(ec_secret& secret, ec_point& pubkey, const ec_point& pkSpend, ec_secret& sharedSOut, ec_point& pkOut)
{
    ...
    */
    ...
    if (!ecgrp)
    {
        LogPrintf("PrivateSecret(): EC_GROUP_new_by_curve_name failed.\n");
        return 1;
    };
    
    if (!(bnCtx = BN_CTX_new()))
    {
        LogPrintf("PrivateSecret(): BN_CTX_new failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecret(): bnEphem BN_bin2bn failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecret(): bnQ BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecret(): Q EC_POINT_bn2point failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecret(): eQ EC_POINT_mul failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecret(): bnOutQ incorrect length.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecret(): BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecret(): C EC_POINT_new failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecret(): C EC_POINT_mul failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecret(): bnR BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecret(): R EC_POINT_bn2point failed\n");
        rv = 1;
        goto End;
    };
    ...
    if (!EC_POINT_mul(ecgrp, C, bnc, NULL, NULL, bnCtx))
    {
        printf("PrivateSecret(): C EC_POINT_mul failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("PrivateSecret(): Rout EC_POINT_new failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecret(): Rout EC_POINT_add failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecret(): Rout EC_POINT_bn2point failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecret(): pkOut incorrect length.\n");
        rv = 1;
        goto End;
    };
...
int PrivateSecretSpend(ec_secret& scanSecret, ec_point& ephemPubkey, ec_secret& spendSecret, ec_secret& secretOut)
{
    ...
    */
    ...
    if (!ecgrp)
    {
        LogPrintf("PrivateSecretSpend(): EC_GROUP_new_by_curve_name failed.\n");
        return 1;
    };
    
    if (!(bnCtx = BN_CTX_new()))
    {
        LogPrintf("PrivateSecretSpend(): BN_CTX_new failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecretSpend(): bnScanSecret BN_bin2bn failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecretSpend(): bnP BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecretSpend(): P EC_POINT_bn2point failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecretSpend(): dP EC_POINT_mul failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecretSpend(): bnOutP incorrect length.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecretSpend(): BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecretSpend(): EC_GROUP_get_order failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecretSpend(): bnSpend BN_bin2bn failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecretSpend(): bnSpend BN_mod_add failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecretSpend(): bnSpend is zero.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        LogPrintf("PrivateSecretSpend(): bnSpend incorrect length.\n");
        rv = 1;
        goto End;
    };
...
bool IsPrivateAddress(const std::string& encodedAddress)
{
    ...
    if (!DecodeBase58(encodedAddress, raw))
    {
        //LogPrintf("IsPrivateAddress DecodeBase58 falied.\n");
        return false;
    };
    
    if (!VerifyChecksum(raw))
    {
        //LogPrintf("IsPrivateAddress verify_checksum falied.\n");
        return false;
    };
    
    if (raw.size() < 1 + 1 + 33 + 1 + 33 + 1 + 1 + 4)
    {
        //LogPrintf("IsPrivateAddress too few bytes provided.\n");
        return false;
    };
    ...
    if (version != private_version_byte)
    {
        //LogPrintf("IsPrivateAddress version mismatch 0x%x != 0x%x.\n", version, private_version_byte);
        return false;
    };
