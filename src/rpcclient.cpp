...
Array RPCConvertValues(const std::string &strMethod, const std::vector<std::string> &strParams)
{
    ...
    if (strMethod == "instantsendtoaddress"          && n > 1) ConvertTo<double>(params[1]);
    if (strMethod == "sendtoprivateaddress"          && n > 1) ConvertTo<double>(params[1]);
    ...
    if (strMethod == "scanforprivatetxns"          && n > 0) ConvertTo<int64_t>(params[0]);
