UNIX BUILD NOTES
====================
Some notes on how to build BOLT in Unix. 
...
memory available when compiling BOLT Core. With 512MB of memory or less
...
If you want to build BOLT-Qt, make sure that the required packages for Qt development
...
For Qt 5 you need the following (Ubuntu 17.10 and later):

    sudo apt-get install libqt5gui5 libqt53core5 libqt5dbus5 qttools5-dev qttools5-dev-tools libprotobuf-dev protobuf-compiler
...
Security
--------
To help make your BOLT installation more secure by making certain attacks impossible to
